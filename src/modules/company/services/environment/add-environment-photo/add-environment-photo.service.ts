...
export class AddEnvironmentPhotoService {
  ...
  async execute(addPhotoEnvironmentDto: AddPhotoEnvironmentDto, userPayloadDto: UserPayloadDto, file: Express.Multer.File) {
    ...
    await this.environmentPhotoRepository.createMany([
      {
        ...
        companyCharacterizationId: addPhotoEnvironmentDto.companyCharacterizationId,
        photoUrl,
