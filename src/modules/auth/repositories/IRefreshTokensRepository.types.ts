...
interface IRefreshTokensRepository {
  ...
  findByRefreshToken(refresh_token: string): Promise<RefreshTokenEntity | undefined>;
  findByUserIdAndRefreshToken(userId: number, refresh_token: string): Promise<RefreshTokenEntity | undefined>;
