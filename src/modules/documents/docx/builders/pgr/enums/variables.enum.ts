export enum VariablesPGREnum {
  ...
  ENVIRONMENT_DESCRIPTION = 'DESCRIÇÃO_DO_AMBIENTE', //! CHANGED
  ENVIRONMENT_GENERAL_DESCRIPTION = 'DESCRIÇÃO_GERAL_DO_AMBIENTE', //! CHANGED
  ENVIRONMENT_IMAGES = 'FOTOS_DO_AMBIENTE',
  ENVIRONMENT_MOISTURE = 'HUMIDADE_DO_AMBIENTE', //! CHANGED
  ENVIRONMENT_NOISE = 'RUIDO_DO_AMBIENTE', //! CHANGED
  ENVIRONMENT_LUMINOSITY = 'LUMINOSIDADE_DO_AMBIENTE', //! CHANGED
  ENVIRONMENT_TEMPERATURE = 'TEMPERATURA_DO_AMBIENTE',
  ENVIRONMENT_NAME = 'NOME_DO_AMBIENTE', //! CHANGED
  PROFILE_NAME = 'NOME_DO_PERFIL_AMBIENTE', //! CHANGED
  CHARACTERIZATION_NAME = 'NOME_DO_POSTO_E_ATIVIDADE', //! CHANGED
