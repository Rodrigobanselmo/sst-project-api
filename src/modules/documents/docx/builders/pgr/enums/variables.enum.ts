export enum VariablesPGREnum {
  ...
  WORKSPACE_NAME = 'NOME_ESTABELECIMENTO',
  WORKSPACE_LEGAL_NAME = 'RAZAO_SOCIAL_ESTABELECIMENTO',
  WORKSPACE_STREET = 'LOGRADOURO_ESTABELECIMENTO',
  WORKSPACE_NUMBER = 'NUMERO_ESTABELECIMENTO',
  WORKSPACE_NEIGHBOR = 'BAIRRO_ESTABELECIMENTO',
  WORKSPACE_CITY = 'CIDADE_ESTABELECIMENTO',
  WORKSPACE_STATE = 'UF_ESTABELECIMENTO',
  WORKSPACE_CEP = 'CEP_ESTABELECIMENTO',
  WORKSPACE_INITIAL = 'SIGLA_ESTABELECIMENTO',
  WORKSPACE_CNAE = 'CNAE_ESTABELECIMENTO',
  WORKSPACE_RISK_DEGREE = 'GRAU_DE_RISCO_ESTABELECIMENTO',
  WORKSPACE_WORK_TIME = 'HORARIO_DE_TRABALHO_ESTABELECIMENTO',
