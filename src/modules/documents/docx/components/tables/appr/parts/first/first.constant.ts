...
const RewRiskInventoryHeader = (): bodyTableProps[] => {
  ...
  header[FirstRiskInventoryColumnEnum.REVIEW] = {
    text: 'Revisão:',
    bold: true,
  };
  header[FirstRiskInventoryColumnEnum.ELABORATION_BY] = {
    text: 'Elaborador:',
    bold: true,
  };
  header[FirstRiskInventoryColumnEnum.APPROVE_BY] = {
    text: 'Aprovação:',
    bold: true,
  };
  header[FirstRiskInventoryColumnEnum.DATA] = { text: 'Data:', bold: true };
  header[FirstRiskInventoryColumnEnum.UNIT] = {
