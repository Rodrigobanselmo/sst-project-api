...
const NewVersionControlHeader = (): headerTableProps[] => {
  ...
  header[VersionControlColumnEnum.DESCRIPTION] = { text: 'Histórico das Alterações', size: 15 }
  header[VersionControlColumnEnum.REVISION_BY] = { text: 'Revisado por:', size: 5 }
  header[VersionControlColumnEnum.APPROVE_BY] = { text: 'Aprovado por:', size: 6 }
  header[VersionControlColumnEnum.SIGNATURE] = { text: 'Assinaturas:', size: 5 }
