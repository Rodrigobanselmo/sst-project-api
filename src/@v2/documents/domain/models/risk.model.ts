...
export class RiskModel {
  ...
  constructor(params: IRiskModel) {
    ...
    this.nioshRel = params.nioshRel;
    this.nioshStel = params.nioshStel;
    this.nioshCeiling = params.nioshCeiling;
    this.oshaPel = params.oshaPel;
    this.oshaStel = params.oshaStel;
    this.oshaCeiling = params.oshaCeiling;
    this.aihaWeel = params.aihaWeel;
    this.aihaWeelCeiling = params.aihaWeelCeiling;
    this.pe = params.pe;
    this.pv = params.pv;
