import { ISectionChildrenType } from "../../application/libs/docx/builders/pgr/types/elements.types";
import { IAllDocumentSectionType } from "../../application/libs/docx/builders/pgr/types/section.types";
