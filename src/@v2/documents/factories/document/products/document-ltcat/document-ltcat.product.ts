...
import { IProductDocumentLTCAT } from './document-ltcat.types';

export class ProductDocumentLTCAT implements IDocumentFactoryProduct<IProductDocumentLTCAT, DocumentPGRModel> {
  ...
  public async getAttachments({ data }: IGetAttachments<IProductDocumentLTCAT, DocumentPGRModel>) {
    return [];
  }

  public async getSections({ data, attachments }: IGetDocument<IProductDocumentLTCAT, DocumentPGRModel>) {
  ...
  public async save({ attachments, body, url }: ISaveDocument<IProductDocumentLTCAT, DocumentPGRModel>) {
  ...
  public async error({ body }: ISaveErrorDocument<IProductDocumentLTCAT>) {
    const documentVersion = new DocumentVersionEntity({
      id: body.documentVersionId,
  ...
  public getFileName = (data: DocumentPGRModel, type = 'LTCAT') => {
