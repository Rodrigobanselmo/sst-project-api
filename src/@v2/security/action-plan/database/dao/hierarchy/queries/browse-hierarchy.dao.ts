...
export class HierarchyBrowseQuerie {
  constructor(
  ...
  private filterWhere(filters: IHierarchyDAO.BrowseParams['filters']) {
    ...
    if (filters.type?.length) {
      where.push(Prisma.sql`hierarchy."type"::text IN (${Prisma.join(filters.type)})`)
    }
...
//     field: HierarchyOrderByEnum.PARENT_NAME_1,
//     order: OrderByDirectionEnum.ASC
//   }, {
//     field: HierarchyOrderByEnum.PARENT_NAME_2,
//     order: OrderByDirectionEnum.ASC
//   }, {
//     field: HierarchyOrderByEnum.PARENT_NAME_3,
//     order: OrderByDirectionEnum.ASC
//   }, {
//     field: HierarchyOrderByEnum.PARENT_NAME_4,
//     order: OrderByDirectionEnum.ASC
//   }, {
//     field: HierarchyOrderByEnum.PARENT_NAME_5,
//     order: OrderByDirectionEnum.ASC
//   }, {
//     field: HierarchyOrderByEnum.NAME,
//     order: OrderByDirectionEnum.ASC
//   }],
//   filters: {
