...
import { ReadAbsenteeismTimelineTotalUseCase } from '../use-cases/read-absenteeism.usecase';
import { AbsenteeismPath } from './read-absenteeism.path';
import { AbsenteeismQuery } from './read-absenteeism.query';

@Controller(AbsenteeismRoutes.DASHBOARD.TIMELINE_TOTAL)
@UseGuards(JwtAuthGuard)
export class ReadAbsenteeismTimelineTotalController {
  constructor(private readonly absenteeismUseCase: ReadAbsenteeismTimelineTotalUseCase) {}
