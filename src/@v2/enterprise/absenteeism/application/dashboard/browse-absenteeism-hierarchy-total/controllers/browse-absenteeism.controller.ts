...
import { BrowseAbsenteeismHierarchyTotalUseCase } from '../use-cases/browse-absenteeism.usecase';
...
@Controller(AbsenteeismRoutes.DASHBOARD.HIERARCHY_TOTAL_BROWSE)
@UseGuards(JwtAuthGuard)
export class BrowseAbsenteeismHierarchTotalController {
  constructor(private readonly browseAbsenteeismUseCase: BrowseAbsenteeismHierarchyTotalUseCase) {}
