...
import { ReadAbsenteeismDaysCountUseCase } from '../use-cases/read-absenteeism.usecase';
import { AbsenteeismPath } from './read-absenteeism.path';
import { AbsenteeismQuery } from './read-absenteeism.query';

@Controller(AbsenteeismRoutes.DASHBOARD.DAYS_COUNT)
@UseGuards(JwtAuthGuard)
export class ReadAbsenteeismDaysCountController {
  constructor(private readonly absenteeismUseCase: ReadAbsenteeismDaysCountUseCase) {}
