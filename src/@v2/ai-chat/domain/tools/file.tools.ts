 ...
 */
export function createFileTools(prisma: PrismaClient, userId: number): StructuredToolInterface[] {
  const rereadFileTool = tool(
    ...
    },
    {
      ...
      schema: z.object({
        ...
        fileId: z.string().describe('The file ID to re-read. You can find file IDs in the [Previously attached ...] or [Attached ...] annotations in conversation history.'),
      }),
    },
  );
