...
export const clothesMap = {
  [ClothesIBTUG.CLOTHES_NA]: {
    type: ClothesIBTUG.CLOTHES_NA,
    value: 0,
    content: 'Uniforme de trabalho (calça e camisa de manga comprida)',
  },
  [ClothesIBTUG.CLOTHES_0]: {
    type: ClothesIBTUG.CLOTHES_0,
    value: 0,
    content: 'Macacão de tecido',
  },
