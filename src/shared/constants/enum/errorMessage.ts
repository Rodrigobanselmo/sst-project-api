export enum ErrorMessageEnum {
  ...
  ESOCIAL_FORBIDDEN_HIER_DELETION = 'Eventos do eSocial vinculado. Você não possui permissão para alterar eventos já enviados',
  ...
  EMPLOYEE_BLOCK_HISTORY_SAME_OFFICE = 'histórico bagunçado, funcionário já cadastrado neste cargo',
...
export enum ErrorCompanyEnum {
  ...
  FILE_ALREADY_EXISTS = 'Arquivo já cadastrada',
...
export enum ErrorInvitesEnum {
  ...
  FORBIDDEN_INSUFFICIENT_PERMISSIONS = 'Você não tem permissão para criar/editar um usuário com essas credenciais',
