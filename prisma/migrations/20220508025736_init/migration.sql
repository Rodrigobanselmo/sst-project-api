...
CREATE TABLE "RiskFactorData" (
    ...
    "probabilityAfter" INTEGER NOT NULL,
    "riskId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "_RecMedToRiskFactorData" (
    "A" TEXT NOT NULL,
    "B" TEXT NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_RecMedToRiskFactorData_AB_unique" ON "_RecMedToRiskFactorData"("A", "B");

-- CreateIndex
CREATE INDEX "_RecMedToRiskFactorData_B_index" ON "_RecMedToRiskFactorData"("B");
...
-- AddForeignKey
ALTER TABLE "RiskFactorData" ADD CONSTRAINT "RiskFactorData_homogeneousGroupId_fkey" FOREIGN KEY ("homogeneousGroupId") REFERENCES "HomogeneousGroup"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RiskFactorData" ADD CONSTRAINT "RiskFactorData_hierarchyId_fkey" FOREIGN KEY ("hierarchyId") REFERENCES "Hierarchy"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_RecMedToRiskFactorData" ADD FOREIGN KEY ("A") REFERENCES "RecMed"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_RecMedToRiskFactorData" ADD FOREIGN KEY ("B") REFERENCES "RiskFactorData"("id") ON DELETE CASCADE ON UPDATE CASCADE;
