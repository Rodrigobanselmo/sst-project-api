...
import { IEmployee2240Data, IEvent2240Props } from './../../../../modules/esocial/interfaces/event-2240';
...
export declare namespace IESocial2220 {
    ...
    interface XmlReturn extends Omit<StructureReturn, 'event'> {
        signedXml: string;
        xml: string;
    }
}
...
export declare namespace IESocial3000 {
    ...
    interface StructureReturn extends Event {
        id: string;
