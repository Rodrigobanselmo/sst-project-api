...
class UserPayloadDto extends UserCompanyDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { userId: { required: true, type: () => Number }, email: { required: true, type: () => String }, isMaster: { required: true, type: () => Boolean }, targetCompanyId: { required: false, type: () => String } };
    }
}
__decorate([
