...
const cidSheet_constant_1 = require("./sheets/cid/cidSheet.constant");
const cnaeSheet_constant_1 = require("./sheets/cnae/cnaeSheet.constant");
...
exports.workbooksConstant = {
    ...
    [workbooks_enum_1.WorkbooksEnum.CNAE]: {
        name: 'CNAE',
        id: workbooks_enum_1.WorkbooksEnum.CNAE,
        sheets: cnaeSheet_constant_1.cnaeSheetConstant,
        path: 'files/cnae',
    },
    [workbooks_enum_1.WorkbooksEnum.CID]: {
        name: 'CID',
        id: workbooks_enum_1.WorkbooksEnum.CID,
        sheets: cidSheet_constant_1.cidSheetConstant,
        path: 'files/cid',
    },
};
