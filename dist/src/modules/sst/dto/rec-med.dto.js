...
class CreateRecMedDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { riskId: { required: true, type: () => String }, recName: { required: false, type: () => String }, medName: { required: false, type: () => String }, medType: { required: false, type: () => Object }, recType: { required: false, type: () => Object }, status: { required: false, type: () => Object }, companyId: { required: true, type: () => String } };
    }
}
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsEnum)(client_1.RecTypeEnum, {
        message: `type must be one of: ${(0, keysOfEnum_utils_1.KeysOfEnum)(client_1.RecTypeEnum)}`,
    }),
    __metadata("design:type", String)
], CreateRecMedDto.prototype, "recType", void 0);
__decorate([
    (0, class_transformer_1.Transform)(string_uppercase_transform_1.StringUppercaseTransform, { toClassOnly: true }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
...
class UpdateRecMedDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { recName: { required: false, type: () => String }, medName: { required: false, type: () => String }, medType: { required: false, type: () => Object }, recType: { required: false, type: () => Object }, status: { required: false, type: () => Object }, companyId: { required: true, type: () => String } };
    }
}
__decorate([
    (0, class_transformer_1.Transform)(string_capitalize_paragraph_1.StringCapitalizeParagraphTransform, { toClassOnly: true }),
...
__decorate([
    ...
    __metadata("design:type", String)
], UpdateRecMedDto.prototype, "recType", void 0);
__decorate([
    (0, class_transformer_1.Transform)(string_uppercase_transform_1.StringUppercaseTransform, { toClassOnly: true }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
...
class RiskCreateRecMedDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { recName: { required: false, type: () => String }, medName: { required: false, type: () => String }, medType: { required: false, type: () => Object }, recType: { required: false, type: () => Object }, status: { required: false, type: () => Object } };
    }
}
__decorate([
    (0, class_transformer_1.Transform)(string_capitalize_paragraph_1.StringCapitalizeParagraphTransform, { toClassOnly: true }),
...
__decorate([
    ...
    __metadata("design:type", String)
], RiskCreateRecMedDto.prototype, "recType", void 0);
__decorate([
    (0, class_transformer_1.Transform)(string_uppercase_transform_1.StringUppercaseTransform, { toClassOnly: true }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
...
class RiskUpdateRecMedDto extends (0, swagger_1.PartialType)(RiskCreateRecMedDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return { medType: { required: false, type: () => Object }, recType: { required: false, type: () => Object }, id: { required: true, type: () => String } };
    }
}
__decorate([
    (0, class_transformer_1.Transform)(string_uppercase_transform_1.StringUppercaseTransform, { toClassOnly: true }),
...
__decorate([
    ...
    __metadata("design:type", String)
], RiskUpdateRecMedDto.prototype, "recType", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
