...
class UpsertRiskDocumentDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: false, type: () => String }, name: { required: true, type: () => String }, riskGroupId: { required: false, type: () => String }, pcmsoId: { required: false, type: () => String }, version: { required: true, type: () => String }, workspaceId: { required: true, type: () => String }, workspaceName: { required: true, type: () => String }, fileUrl: { required: false, type: () => String }, description: { required: false, type: () => String }, status: { required: false, type: () => Object }, companyId: { required: true, type: () => String }, attachments: { required: false, type: () => [require("./attachment.dto").AttachmentDto] } };
    }
}
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], UpsertRiskDocumentDto.prototype, "pcmsoId", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
], UpsertRiskDocumentDto.prototype, "attachments", void 0);
