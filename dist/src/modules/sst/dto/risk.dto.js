...
exports.FindRiskDto = exports.UpdateRiskDto = exports.UpsertRiskDto = exports.CreateRiskDto = void 0;
...
], CreateRiskDto.prototype, "isEmergency", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateRiskDto.prototype, "risk", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateRiskDto.prototype, "esocialCode", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateRiskDto.prototype, "symptoms", void 0);
__decorate([
...
__decorate([
    ...
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateRiskDto.prototype, "isAso", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateRiskDto.prototype, "isPGR", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateRiskDto.prototype, "isPCMSO", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CreateRiskDto.prototype, "isPPP", void 0);
...
class UpdateRiskDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, type: { required: false, type: () => Object }, name: { required: false, type: () => String }, severity: { required: false, type: () => Number }, status: { required: false, type: () => Object }, companyId: { required: true, type: () => String }, risk: { required: false, type: () => String }, symptoms: { required: false, type: () => String }, isEmergency: { required: false, type: () => Boolean }, recMed: { required: false, type: () => [require("./rec-med.dto").RiskUpdateRecMedDto] }, generateSource: { required: false, type: () => [require("./generate-source.dto").RiskUpdateGenerateSourceDto] } };
    }
}
__decorate([
    (0, class_validator_1.IsString)(),
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Number)
], UpdateRiskDto.prototype, "severity", void 0);
__decorate([
    (0, class_transformer_1.Transform)(string_uppercase_transform_1.StringUppercaseTransform, { toClassOnly: true }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], UpdateRiskDto.prototype, "risk", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], UpdateRiskDto.prototype, "symptoms", void 0);
__decorate([
    (0, class_validator_1.IsBoolean)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Boolean)
], UpdateRiskDto.prototype, "isEmergency", void 0);
__decorate([
    (0, class_validator_1.ValidateNested)({ each: true }),
    (0, class_validator_1.IsOptional)(),
...
class FindRiskDto extends pagination_dto_1.PaginationQueryDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { search: { required: true, type: () => String }, companyId: { required: true, type: () => String }, representAll: { required: true, type: () => Boolean } };
    }
}
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], FindRiskDto.prototype, "search", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], FindRiskDto.prototype, "companyId", void 0);
__decorate([
    (0, class_validator_1.IsBoolean)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Boolean)
], FindRiskDto.prototype, "representAll", void 0);
exports.FindRiskDto = FindRiskDto;
