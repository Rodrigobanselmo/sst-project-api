...
let FindExamRiskService = class FindExamRiskService {
    ...
    async execute(_a, user) {
        ...
        const Exam = await this.examRiskRepository.find(Object.assign({ companyId: user.targetCompanyId }, query), { skip, take }, {
            include: {
...
FindExamRiskService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [ExamRiskRepository_1.ExamRiskRepository])
], FindExamRiskService);
exports.FindExamRiskService = FindExamRiskService;
//# sourceMappingURL=find-exam.service.js.map