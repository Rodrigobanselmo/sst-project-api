...
exports.CreateProtocolsService = void 0;
const common_1 = require("@nestjs/common");
const ProtocolRepository_1 = require("../../../repositories/implementations/ProtocolRepository");
let CreateProtocolsService = class CreateProtocolsService {
    ...
    async execute(UpsertProtocolsDto, user) {
        ...
        const protocol = await this.protocolRepository.create(Object.assign(Object.assign({}, UpsertProtocolsDto), { companyId: user.targetCompanyId, system }));
        return protocol;
    }
};
CreateProtocolsService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [ProtocolRepository_1.ProtocolRepository])
], CreateProtocolsService);
exports.CreateProtocolsService = CreateProtocolsService;
