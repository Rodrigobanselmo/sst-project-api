...
const find_by_company_service_1 = require("../../services/risk/find-by-company/find-by-company.service");
const find_service_1 = require("../../services/risk/find/find.service");
let RiskController = class RiskController {
    constructor(createRiskService, updateRiskService, findAllAvailableRiskService, findRisksByCompanyService, findRiskService, deleteSoftRiskService) {
        ...
        this.findRisksByCompanyService = findRisksByCompanyService;
        this.findRiskService = findRiskService;
    ...
    findByCompany(userPayloadDto, query) {
...
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.RISK,
        crud: true,
        isMember: true,
    }),
    (0, common_1.Post)(),
    ...
    __metadata("design:paramtypes", [user_payload_dto_1.UserPayloadDto, risk_dto_1.CreateRiskDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, user_payload_dto_1.UserPayloadDto, risk_dto_1.UpdateRiskDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_payload_dto_1.UserPayloadDto, risk_dto_1.FindRiskDto]),
    __metadata("design:returntype", void 0)
], RiskController.prototype, "findByCompany", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.RISK,
        isMember: true,
...
__decorate([
    ...
    __metadata("design:paramtypes", [user_payload_dto_1.UserPayloadDto, risk_dto_1.FindRiskDto]),
    __metadata("design:returntype", void 0)
], RiskController.prototype, "find", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.RISK,
        crud: true,
...
RiskController = __decorate([
    ...
    __metadata("design:paramtypes", [create_risk_service_1.CreateRiskService,
        ...
        find_by_company_service_1.FindRisksByCompanyService,
