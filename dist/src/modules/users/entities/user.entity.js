...
class UserEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, email: { required: true, type: () => String }, password: { required: true, type: () => String }, updated_at: { required: true, type: () => Date }, created_at: { required: true, type: () => Date }, companies: { required: false, type: () => [require("./userCompany.entity").UserCompanyEntity] } };
    }
}
__decorate([
