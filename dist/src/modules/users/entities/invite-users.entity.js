...
class InviteUsersEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, email: { required: true, type: () => String }, roles: { required: true, type: () => [String] }, permissions: { required: true, type: () => [String] }, expires_date: { required: true, type: () => Date }, companyId: { required: true, type: () => String } };
    }
}
__decorate([
