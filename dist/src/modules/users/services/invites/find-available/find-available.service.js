...
let FindAvailableService = class FindAvailableService {
    ...
    async execute(_a, user) {
        ...
        const access = await this.inviteUsersRepository.find(Object.assign({}, query), { skip, take });
        return access;
    }
};
FindAvailableService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [InviteUsersRepository_1.InviteUsersRepository])
], FindAvailableService);
exports.FindAvailableService = FindAvailableService;
//# sourceMappingURL=find-available.service.js.map