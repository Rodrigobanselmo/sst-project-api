...
let ResetPasswordService = class ResetPasswordService {
    ...
    async execute({ tokenId, password }) {
        ...
        if (!(refresh_token === null || refresh_token === void 0 ? void 0 : refresh_token.id))
            throw new common_1.BadRequestException(errorMessage_1.ErrorInvitesEnum.TOKEN_NOT_FOUND);
