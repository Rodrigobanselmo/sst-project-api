...
let UpdateUserService = class UpdateUserService {
    ...
    async execute(id, _a) {
        ...
        const { companies, email, companyId } = await (0, create_user_service_1.getCompanyPermissionByToken)(token, userData.email, this.findByTokenService, this.dateProvider);
