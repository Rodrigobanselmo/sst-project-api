...
class UserCompanyDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { companyId: { required: true, type: () => String }, roles: { required: true, type: () => [String] }, permissions: { required: true, type: () => [String] }, groupId: { required: false, type: () => Number }, status: { required: false, type: () => Object } };
    }
}
__decorate([
...
], UserCompanyDto.prototype, "groupId", void 0);
__decorate([
