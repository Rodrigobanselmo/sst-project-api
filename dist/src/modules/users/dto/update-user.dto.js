...
class UpdateUserDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { oldPassword: { required: false, type: () => String }, password: { required: false, type: () => String, minLength: 8, maxLength: 20 }, name: { required: false, type: () => String, maxLength: 100 }, token: { required: false, type: () => String } };
    }
}
__decorate([
