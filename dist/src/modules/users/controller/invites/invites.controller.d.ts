...
export declare class InvitesController {
    ...
    constructor(inviteUsersService: InviteUsersService, findAllByCompanyIdService: FindAllByCompanyIdService, findAllByEmailService: FindAllByEmailService, deleteInvitesService: DeleteInvitesService, deleteExpiredInvitesService: DeleteExpiredInvitesService);
