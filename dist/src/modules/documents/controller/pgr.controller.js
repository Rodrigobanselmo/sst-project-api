...
exports.DocumentsPgrController = void 0;
...
let DocumentsPgrController = class DocumentsPgrController {
    ...
    async uploadPGRDoc(res, userPayloadDto, upsertPgrDto) {
        const { buffer: file, fileName } = await this.pgrUploadDocService.execute(Object.assign(Object.assign({}, upsertPgrDto), { companyId: userPayloadDto.targetCompanyId }));
        res.setHeader('Content-Disposition', `attachment; filename=${fileName}`);
        res.send(file);
    }
    async uploadPGRActionPlanDoc(res, userPayloadDto, upsertPgrDto) {
...
], DocumentsPgrController.prototype, "downloadAttachment", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.PGR,
        isMember: true,
    ...
    __metadata("design:returntype", Promise)
], DocumentsPgrController.prototype, "downloadPGR", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.PGR,
        isMember: true,
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, user_payload_dto_1.UserPayloadDto, pgr_dto_1.UpsertPgrDocumentDto]),
    __metadata("design:returntype", Promise)
], DocumentsPgrController.prototype, "uploadPGRDoc", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.PGR,
        isMember: true,
    ...
    (0, common_1.Post)('action-plan'),
    openapi.ApiResponse({ status: 201 }),
    __param(0, (0, common_1.Res)()),
    __param(1, (0, user_decorator_1.User)()),
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, user_payload_dto_1.UserPayloadDto, pgr_dto_1.UploadPgrActionPlanDto]),
    __metadata("design:returntype", Promise)
], DocumentsPgrController.prototype, "uploadPGRActionPlanDoc", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.PGR,
        isMember: true,
    ...
    __metadata("design:returntype", Promise)
], DocumentsPgrController.prototype, "addQueuePGRDoc", null);
DocumentsPgrController = __decorate([
    (0, common_1.Controller)('documents/pgr'),
...
exports.DocumentsPgrController = DocumentsPgrController;
//# sourceMappingURL=pgr.controller.js.map