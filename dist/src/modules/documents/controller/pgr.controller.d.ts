...
export declare class DocumentsPgrController {
    ...
    uploadPGRDoc(res: any, userPayloadDto: UserPayloadDto, upsertPgrDto: UpsertPgrDocumentDto): Promise<void>;
    uploadPGRActionPlanDoc(res: any, userPayloadDto: UserPayloadDto, upsertPgrDto: UploadPgrActionPlanDto): Promise<void>;
