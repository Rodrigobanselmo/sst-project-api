    ...
    hierarchies
        ...
        const loop = (parentId) => {
            ...
            hierarchyArrayData[parentInfo.index] = {
                ...
                name: parent.name,
                homogeneousGroupIds: (_a = parent === null || parent === void 0 ? void 0 : parent.homogeneousGroups) === null || _a === void 0 ? void 0 : _a.map((group) => group.id),
        ...
        hierarchyArrayData[hierarchyInfo.index] = {
            ...
            name: hierarchy.name,
            homogeneousGroupIds: (_a = hierarchy === null || hierarchy === void 0 ? void 0 : hierarchy.homogeneousGroups) === null || _a === void 0 ? void 0 : _a.map((group) => group.id),
