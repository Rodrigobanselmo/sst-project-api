...
const actionPlan_constant_1 = require("../../../../../../modules/documents/utils/sections/tables/actionPlan/actionPlan.constant");
...
const actionPlanTableSection = (riskFactorGroupData) => {
    const actionPlanData = (0, actionPlan_converter_1.actionPlanConverter)(riskFactorGroupData);
