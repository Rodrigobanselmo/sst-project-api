...
export declare const bulletsSpace: (text: string, options?: IParagraphOptions) => Paragraph;
export declare const bulletsArray: (bullets: [string, number?][], options?: IParagraphOptions) => Paragraph[];
