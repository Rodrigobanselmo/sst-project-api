...
class TableBodyElements {
    ...
    tableCell(_a) {
        ...
        return new docx_1.TableCell(Object.assign({ children: [
            ...
            ], margins: { top: 60, bottom: 60 }, shading: { fill: palette_1.palette.table.row.string }, verticalAlign: docx_1.VerticalAlign.CENTER, width: { size, type: docx_1.WidthType.PERCENTAGE } }, rest));
    }
}
