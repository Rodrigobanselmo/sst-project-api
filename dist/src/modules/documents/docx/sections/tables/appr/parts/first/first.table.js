...
const firstRiskInventoryTableSection = (riskFactorGroupData, hierarchyData, isByGroup) => {
    const riskInventoryData = (0, first_converter_1.documentConverter)(riskFactorGroupData, hierarchyData, isByGroup);
