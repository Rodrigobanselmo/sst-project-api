...
const documentConverter = (riskFactorGroupData, hierarchy, isByGroup) => {
    const rows = [];
    ...
    const docData = [];
    docData[first_constant_1.FirstRiskInventoryColumnEnum.SOURCE] =
        riskFactorGroupData.source || '';
    docData[first_constant_1.FirstRiskInventoryColumnEnum.REVIEW] =
        riskFactorGroupData.revisionBy || '';
    docData[first_constant_1.FirstRiskInventoryColumnEnum.ELABORATION_BY] =
        riskFactorGroupData.elaboratedBy || '';
    docData[first_constant_1.FirstRiskInventoryColumnEnum.APPROVE_BY] =
        riskFactorGroupData.approvedBy || '';
    docData[first_constant_1.FirstRiskInventoryColumnEnum.DATA] =
        (0, dayjs_1.default)(riskFactorGroupData.visitDate).format('DD/MM/YYYY') || '';
