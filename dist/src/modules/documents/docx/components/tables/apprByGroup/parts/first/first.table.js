...
const firstRiskInventoryTableSection = (riskFactorGroupData, homoGroupTree, hierarchyData, isByGroup) => {
    const riskInventoryData = (0, first_converter_1.documentConverter)(riskFactorGroupData, homoGroupTree, hierarchyData, isByGroup);
