...
const thirdRiskInventoryTableSection = (riskFactorGroupData, hierarchyData, hierarchyTree) => {
    const data = (0, third_converter_1.dataConverter)(riskFactorGroupData, hierarchyData, hierarchyTree);
