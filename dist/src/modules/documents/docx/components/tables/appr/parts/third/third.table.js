...
const thirdRiskInventoryTableSection = (riskFactorGroupData, hierarchyData, isByGroup) => {
    const data = (0, third_converter_1.dataConverter)(riskFactorGroupData, hierarchyData, isByGroup);
