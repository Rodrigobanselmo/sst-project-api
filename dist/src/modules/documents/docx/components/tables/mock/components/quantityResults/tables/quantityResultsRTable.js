...
exports.quantityResultsRTable = void 0;
...
const quantityResultsRTable = () => {
    ...
    const table = new docx_1.Table({
        ...
        rows: [
            ...
            ...(0, body_converter_1.NewBody)(bodyR_1.rowBodyNoise).map((data) => tableBodyElements.tableRow(data.map(tableBodyElements.tableCell), {
...
exports.quantityResultsRTable = quantityResultsRTable;
//# sourceMappingURL=quantityResultsRTable.js.map