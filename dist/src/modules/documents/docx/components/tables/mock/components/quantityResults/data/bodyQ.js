...
exports.rowBodyQui = void 0;
exports.rowBodyQui = [
    ['Qualquer resultado > IPVS', 'NA', 'Interromper as atividades imediatamente, situação de risco grave e iminente.', 'Interromper as atividades'],
    [
        'MVUE ≥ LEO',
        'IJ ≥ 1',
