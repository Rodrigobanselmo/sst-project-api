...
exports.expositionDegreeATable = void 0;
...
const expositionDegreeATable = () => {
    ...
    const table = new docx_1.Table({
        ...
        rows: [
            ...
            ...(0, body_simple_converter_1.NewBodySimple)(bodyA_1.rowBodyAci).map((data) => tableBodyElements.tableRow(data.map(tableBodyElements.tableCell), {
...
exports.expositionDegreeATable = expositionDegreeATable;
//# sourceMappingURL=expositionDegreeATable.js.map