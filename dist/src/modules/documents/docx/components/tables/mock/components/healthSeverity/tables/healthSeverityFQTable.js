...
exports.healthSeverityFisQuiTable = void 0;
...
const bodyFQ_1 = require("../data/bodyFQ");
const header_converter_1 = require("../header.converter");
const healthSeverityFisQuiTable = () => {
    ...
    const table = new docx_1.Table({
        ...
        rows: [
            ...
            ...(0, body_converter_1.NewBody)(bodyFQ_1.rowBodyFisQui).map((data) => tableBodyElements.tableRow(data.map(tableBodyElements.tableCell), {
...
exports.healthSeverityFisQuiTable = healthSeverityFisQuiTable;
//# sourceMappingURL=healthSeverityFQTable.js.map