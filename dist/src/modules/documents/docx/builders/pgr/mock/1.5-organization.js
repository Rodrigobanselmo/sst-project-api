    ...
    data: [
        {
            ...
            children: [
                ...
                },
                {
                    ...
                    text: `Responsável Legal da Empresa (Responsável pelo PGR) – ??${variables_enum_1.VariablesPGREnum.COMPANY_RESPONSIBLE}??`,
                },
                {
                ...
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.H3,
                    text: `Coordenador Geral do Programa – ??${variables_enum_1.VariablesPGREnum.DOCUMENT_COORDINATOR}??`,
                },
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.BULLET,
                ...
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.PARAGRAPH,
                    text: `A ??${variables_enum_1.VariablesPGREnum.COMPANY_SHORT_NAME}??. deve proporcionar aos trabalhadores treinamento, qualificação, informações, instruções e reciclagem necessárias para preservação da sua segurança e saúde, levando-se em consideração o Grau de Risco e a natureza das operações (NR-01 item 1.7.1).`,
                },
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.PARAGRAPH,
                    text: `A ??${variables_enum_1.VariablesPGREnum.COMPANY_SHORT_NAME}??. deverá Desenvolver um Programa de Treinamento, com reciclagem anual e aplicação de teste para validação do aprendizado, abordando pelo menos os seguintes temas:`,
                },
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.PARAGRAPH,
                    text: '**PGR:**',
                ...
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.BULLET,
                    text: `Ações da ??${variables_enum_1.VariablesPGREnum.COMPANY_SHORT_NAME}??. no Controle de Ruído.`,
                    level: 0,
                },
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.PARAGRAPH,
                ...
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.BULLET,
                    text: `Ações da ??${variables_enum_1.VariablesPGREnum.COMPANY_SHORT_NAME}??. no controle de agentes químicos.`,
                    level: 0,
                },
                {
                    type: elements_types_1.PGRSectionChildrenTypeEnum.PARAGRAPH,
...
//# sourceMappingURL=1.5-organization.js.map