...
let PgrUploadTableService = class PgrUploadTableService {
    ...
    async execute(upsertPgrDto, userPayloadDto) {
        ...
        const { hierarchyData, homoGroupTree, hierarchyHighLevelsData, hierarchyTree } = (0, hierarchy_converter_1.hierarchyConverter)(hierarchyHierarchy, [], { workspaceId });
        const sections = [
            ...(0, appr_group_section_1.APPRByGroupTableSection)(riskGroupData, hierarchyHighLevelsData, hierarchyTree, homoGroupTree, { isByGroup: true }),
        ];
