...
export declare type IClinicExamData = {
...
export declare type IClinicComplementaryData = {
    clinic: CompanyEntity;
    exams: ExamEntity[];
    doneDate: Date;
    time: string;
...
export declare type IClinicComplementaryExamData = Record<string, IClinicComplementaryData>;
