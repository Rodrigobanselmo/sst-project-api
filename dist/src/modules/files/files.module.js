...
const files_checklist_controller_1 = require("./controller/managment/files-checklist.controller");
...
const EpiRepository_1 = require("../sst/repositories/implementations/EpiRepository");
...
const files_cnae_controller_1 = require("./controller/cnae/files-cnae.controller");
...
const files_cid_controller_1 = require("./controller/cid/files-cid.controller");
let FilesModule = class FilesModule {
};
FilesModule = __decorate([
    (0, common_1.Module)({
        controllers: [files_checklist_controller_1.FilesChecklistController, files_company_controller_1.FilesCompanyController, files_cnae_controller_1.FilesCnaeController, files_controller_1.FilesController, files_cid_controller_1.FilesCidController],
        imports: [sst_module_1.SSTModule, company_module_1.CompanyModule],
        providers: [
            ...
            download_cnae_service_1.DownloadCnaeService,
            upload_cnae_service_1.UploadCnaeDataService,
            download_cid_service_1.DownloadCidService,
            upload_cid_service_1.UploadCidDataService,
        ],
    })
], FilesModule);
