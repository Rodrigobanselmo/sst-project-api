...
let UploadEmployeesService = class UploadEmployeesService {
    constructor(excelProvider, companyRepository, employeeRepository, workspaceRepository, databaseTableRepository, uploadExcelProvider, hierarchyRepository) {
    ...
    async execute(file, userPayloadDto) {
        ...
        if (((_a = company.workspace) === null || _a === void 0 ? void 0 : _a.length) === 1)
            Workbook.sheets[0].columns = Workbook.sheets[0].columns.filter((column) => column.databaseName !== 'abbreviation');
        ...
        employeesData = employeesData.map((employee) => {
            var _a;
            const workspace = ((_a = company.workspace) === null || _a === void 0 ? void 0 : _a.length) === 1 ? workspaces : workspaces.filter((work) => (employee === null || employee === void 0 ? void 0 : employee.abbreviation) && (employee === null || employee === void 0 ? void 0 : employee.abbreviation.includes(work.abbreviation)));
            ...
            if (employee === null || employee === void 0 ? void 0 : employee.abbreviation)
        ...
        await (0, asyncEach_1.asyncEach)(hierarchy_list_1.hierarchyList, upsertHierarchy);
            ...
            const getByNameHierarchy = () => {
                Object.keys(client_1.HierarchyEnum).forEach((key) => {
                    ...
                    if (hierarchyName) {
                        ...
                        const actualHierarchy = children.find((h) => (h === null || h === void 0 ? void 0 : h.name) && (h === null || h === void 0 ? void 0 : h.type) && h.name === hierarchyName && h.type === key);
                        if (actualHierarchy) {
