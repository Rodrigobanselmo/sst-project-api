export declare class FilesController {
    findAllTables(): ({
        ...
        name: string;
        id: import("../../../shared/constants/workbooks/workbooks.enum").WorkbooksEnum;
        sheets: Record<import("../../../shared/constants/workbooks/sheets/cnae/cnaeSheet.enum").CnaeSheetEnum, import("../../../shared/constants/workbooks/sheets/cnae/cnaeSheet.constant").ICnaeSheet>;
        path: string;
    } | {
        name: string;
        id: import("../../../shared/constants/workbooks/workbooks.enum").WorkbooksEnum;
        sheets: Record<import("../../../shared/constants/workbooks/sheets/cid/cidSheet.enum").CidSheetEnum, import("../../../shared/constants/workbooks/sheets/cid/cidSheet.constant").ICidSheet>;
        path: string;
    })[];
}
