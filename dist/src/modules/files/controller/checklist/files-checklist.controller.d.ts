...
export declare class FilesChecklistController {
    ...
    private readonly uploadChecklistDataService;
    private readonly downloadRiskDataService;
    constructor(uploadEpiDataService: UploadEpiDataService, uploadChecklistDataService: UploadChecklistDataService, downloadRiskDataService: DownloadRiskDataService);
