        ...
        hierarchies.forEach((hierarchy) => {
            ...
            orderedHierarchy.forEach((employeeWork, index) => {
                if (employeeWork) {
                    ...
                    hierarchyMap[id].type = employeeWork.key.toUpperCase();
    ...
    compare(allMap, compareMap) {
        ...
        const replaceAndEditIfEqual = (allHierarchy, hierarchy, parentId) => {
            ...
            if (!newHierarchy[allHierarchy.id])
                newHierarchy[allHierarchy.id] = Object.assign(Object.assign({}, allHierarchy), { description: (_a = hierarchy === null || hierarchy === void 0 ? void 0 : hierarchy.description) !== null && _a !== void 0 ? _a : allHierarchy.description, realDescription: (_b = hierarchy === null || hierarchy === void 0 ? void 0 : hierarchy.realDescription) !== null && _b !== void 0 ? _b : allHierarchy.realDescription, ghoName: (_c = hierarchy === null || hierarchy === void 0 ? void 0 : hierarchy.ghoName) !== null && _c !== void 0 ? _c : allHierarchy.ghoName, fromOld: true });
            if (newHierarchy[allHierarchy.id].workspaceIds && hierarchy.workspaceId) {
                newHierarchy[allHierarchy.id].workspaceIds = (0, removeDuplicate_1.removeDuplicate)([...newHierarchy[allHierarchy.id].workspaceIds, ...hierarchy.workspaceId], {
                    simpleCompare: true,
                });
            }
            if (parentId)
