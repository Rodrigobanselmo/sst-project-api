...
let HierarchyExcelProvider = class HierarchyExcelProvider {
        ...
        hierarchies.forEach((hierarchy) => {
            ...
            Object.entries(hierarchy).forEach(([key, value]) => {
                if (key === 'directory' && value)
                    orderedHierarchy[0] = { key, value, id: (0, uuid_1.v4)() };
                if (key === 'management' && value)
                    orderedHierarchy[1] = { key, value, id: (0, uuid_1.v4)() };
                if (key === 'sector' && value)
                    orderedHierarchy[2] = { key, value, id: (0, uuid_1.v4)() };
                if (key === 'sub_sector' && value)
                    orderedHierarchy[3] = { key, value, id: (0, uuid_1.v4)() };
                if (key === 'office' && value)
                    orderedHierarchy[4] = { key, value, id: (0, uuid_1.v4)() };
                if (key === 'sub_office' && value)
                    orderedHierarchy[5] = { key, value, id: (0, uuid_1.v4)() };
            });
    ...
    compare(allMap, compareMap) {
        ...
        const isEqualHierarchy = (h1, h2, parent) => {
            const firstEqual = h1.name === h2.name &&
                h1.type === h2.type &&
