...
const employeesSheet_constant_1 = require("../../../shared/constants/workbooks/sheets/employees/employeesSheet.constant");
...
const findAllEmployees = async (excelProvider, companyRepository, workspaceRepository, hierarchyRepository, riskSheet, companyId) => {
    ...
    company.employees = company.employees.map((employee) => {
        const workspace = workspaces.find((workspace) => workspace.id === employee.workplaceId);
