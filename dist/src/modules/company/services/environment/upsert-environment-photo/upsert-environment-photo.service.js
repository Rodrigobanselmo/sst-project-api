...
let UpsertEnvironmentService = class UpsertEnvironmentService {
    ...
    async execute(upsertEnvironmentDto, workspaceId, userPayloadDto) {
        const environments = await this.environmentRepository.upsert(Object.assign(Object.assign({}, upsertEnvironmentDto), { companyId: userPayloadDto.targetCompanyId, workspaceId: workspaceId }));
        return environments;
    }
};
...
//# sourceMappingURL=upsert-environment-photo.service.js.map