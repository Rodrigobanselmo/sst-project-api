...
exports.FindByIdEnvironmentService = void 0;
...
let FindByIdEnvironmentService = class FindByIdEnvironmentService {
    ...
    async execute(id, userPayloadDto) {
        ...
        if (environment.companyId != userPayloadDto.targetCompanyId)
            throw new common_1.BadRequestException(errorMessage_1.ErrorCompanyEnum.ENVIRONMENT_NOT_FOUND);
        return environment;
    }
};
FindByIdEnvironmentService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [EnvironmentRepository_1.EnvironmentRepository])
], FindByIdEnvironmentService);
exports.FindByIdEnvironmentService = FindByIdEnvironmentService;
//# sourceMappingURL=find-by-id-environment.service.js.map