...
exports.CreateHomoGroupService = void 0;
...
let CreateHomoGroupService = class CreateHomoGroupService {
    constructor(homoGroupRepository) {
        this.homoGroupRepository = homoGroupRepository;
    }
    async execute(homoGroup, user) {
        const hasHomoSameName = await this.homoGroupRepository.findHomoGroupByCompanyAndName(homoGroup.name, user.targetCompanyId);
        if (hasHomoSameName === null || hasHomoSameName === void 0 ? void 0 : hasHomoSameName.id)
            throw new common_1.ConflictException(errorMessage_1.ErrorCompanyEnum.HOMOGENEOUS_SAME_NAME);
        const homoGroups = await this.homoGroupRepository.create(homoGroup, user.targetCompanyId);
        return homoGroups;
    }
};
CreateHomoGroupService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [HomoGroupRepository_1.HomoGroupRepository])
], CreateHomoGroupService);
exports.CreateHomoGroupService = CreateHomoGroupService;
//# sourceMappingURL=create-homo-group.service.js.map