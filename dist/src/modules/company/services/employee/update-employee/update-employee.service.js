...
let UpdateEmployeeService = class UpdateEmployeeService {
    ...
    async execute(updateEmployeeDto) {
        ...
        const employee = await this.employeeRepository.update(Object.assign({}, updateEmployeeDto), removeSubOffices);
        return employee;
    }
};
UpdateEmployeeService = __decorate([
