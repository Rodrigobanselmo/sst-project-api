...
exports.CreateHierarchyService = void 0;
...
let CreateHierarchyService = class CreateHierarchyService {
    ...
    async execute(hierarchy, user) {
        if (hierarchy.parentId && hierarchy.type === client_1.HierarchyEnum.DIRECTORY) {
            throw new common_1.BadRequestException(errorMessage_1.ErrorCompanyEnum.CREATE_HIERARCHY_WITH_PARENT);
        }
        const hierarchies = await this.hierarchyRepository.upsert(hierarchy, user.targetCompanyId);
        return hierarchies;
    }
};
CreateHierarchyService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [HierarchyRepository_1.HierarchyRepository])
], CreateHierarchyService);
exports.CreateHierarchyService = CreateHierarchyService;
//# sourceMappingURL=create-hierarchies.service.js.map