...
exports.FindDocumentService = void 0;
const DocumentRepository_1 = require("../../../repositories/implementations/DocumentRepository");
const common_1 = require("@nestjs/common");
let FindDocumentService = class FindDocumentService {
    constructor(documentRepository) {
        this.documentRepository = documentRepository;
    }
    async execute(_a, user) {
        var { skip, take } = _a, query = __rest(_a, ["skip", "take"]);
        const access = await this.documentRepository.find(Object.assign({ companyId: user.targetCompanyId }, query), { skip, take }, {
            select: {
                fileUrl: true,
                endDate: true,
                startDate: true,
