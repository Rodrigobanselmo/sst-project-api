...
export declare class EmployeeRepository {
    ...
    create({ workspaceIds, hierarchyId, companyId, ...createCompanyDto }: CreateEmployeeDto): Promise<EmployeeEntity>;
    update({ workspaceIds, hierarchyId, companyId, id, ...createCompanyDto }: UpdateEmployeeDto): Promise<EmployeeEntity>;
