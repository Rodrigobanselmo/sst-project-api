...
const upsert_many_hierarchies_service_1 = require("../../services/hierarchy/update-simple-many-hierarchies /upsert-many-hierarchies.service");
const upsert_many_hierarchies_service_2 = require("../../services/hierarchy/upsert-many-hierarchies/upsert-many-hierarchies.service");
let HierarchyController = class HierarchyController {
    constructor(findAllHierarchyService, createHierarchyService, updateHierarchyService, upsertManyHierarchyService, deleteHierarchyService, findHierarchyService, updateSimpleManyHierarchyService, createSubHierarchyService) {
        ...
        this.findHierarchyService = findHierarchyService;
        this.updateSimpleManyHierarchyService = updateSimpleManyHierarchyService;
        this.createSubHierarchyService = createSubHierarchyService;
    }
    ...
    updateSimpleMany(upsertManyHierarchyDto, userPayloadDto) {
    ...
    upsert(createSubHierarchyDto, userPayloadDto) {
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], HierarchyController.prototype, "findById", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.EMPLOYEE,
        isContract: true,
    ...
    __param(1, (0, user_decorator_1.User)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [hierarchy_1.CreateHierarchyDto, user_payload_dto_1.UserPayloadDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, common_1.Post)('/upsert-many/:companyId?'),
    openapi.ApiResponse({ status: 201, type: [require("../../entities/hierarchy.entity").HierarchyEntity] }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, user_decorator_1.User)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [hierarchy_1.UpsertManyHierarchyDto, user_payload_dto_1.UserPayloadDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, common_1.Post)('/simple-update-many/:companyId?'),
    openapi.ApiResponse({ status: 201, type: [require("../../entities/hierarchy.entity").HierarchyEntity] }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, user_decorator_1.User)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [hierarchy_1.UpdateSimpleManyHierarchyDto, user_payload_dto_1.UserPayloadDto]),
    __metadata("design:returntype", void 0)
], HierarchyController.prototype, "updateSimpleMany", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.EMPLOYEE,
        isContract: true,
...
__decorate([
    ...
    (0, common_1.Post)('/sub-office/:companyId?'),
    openapi.ApiResponse({ status: 201 }),
    __param(0, (0, common_1.Body)()),
    __param(1, (0, user_decorator_1.User)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [hierarchy_1.CreateSubHierarchyDto, user_payload_dto_1.UserPayloadDto]),
    __metadata("design:returntype", void 0)
], HierarchyController.prototype, "upsert", null);
HierarchyController = __decorate([
    ...
    __metadata("design:paramtypes", [find_all_hierarchies_service_1.FindAllHierarchyService,
        ...
        upsert_many_hierarchies_service_2.UpsertManyHierarchyService,
        delete_hierarchies_service_1.DeleteHierarchyService,
        find_hierarchy_service_1.FindHierarchyService,
        upsert_many_hierarchies_service_1.UpdateSimpleManyHierarchyService,
