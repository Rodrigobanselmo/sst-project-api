...
export declare class EnvironmentController {
    ...
    private readonly updateEnvironmentPhotoService;
    private readonly deleteEnvironmentPhotoService;
    private readonly findByIdEnvironmentService;
    constructor(upsertEnvironmentService: UpsertEnvironmentService, findAllEnvironmentService: FindAllEnvironmentService, deleteEnvironmentService: DeleteEnvironmentService, addEnvironmentPhotoService: AddEnvironmentPhotoService, updateEnvironmentPhotoService: UpdateEnvironmentPhotoService, deleteEnvironmentPhotoService: DeleteEnvironmentPhotoService, findByIdEnvironmentService: FindByIdEnvironmentService);
    findAll(userPayloadDto: UserPayloadDto, workspaceId: string): Promise<import("../../entities/environment.entity").EnvironmentEntity[]>;
    findById(userPayloadDto: UserPayloadDto, id: string): Promise<import("../../entities/environment.entity").EnvironmentEntity>;
    ...
    update(updatePhotoEnvironmentDto: UpdatePhotoEnvironmentDto, id: string): Promise<import("../../entities/environment.entity").EnvironmentEntity>;
