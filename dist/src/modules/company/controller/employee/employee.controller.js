...
let EmployeeController = class EmployeeController {
    constructor(createEmployeeService, updateEmployeeService, findEmployeeService, findAllAvailableEmployeesService, deleteSubOfficeEmployeeService) {
        ...
        this.deleteSubOfficeEmployeeService = deleteSubOfficeEmployeeService;
    }
    create(createEmployeeDto) {
        return this.createEmployeeService.execute(createEmployeeDto);
    }
    deleteSubOffice(employeeId, companyId, subOfficeId) {
...
__decorate([
    ...
    (0, common_1.Post)('/:employeeId/sub-office/:subOfficeId/:companyId'),
    openapi.ApiResponse({ status: 201, type: require("../../entities/employee.entity").EmployeeEntity }),
    __param(0, (0, common_1.Param)('employeeId')),
    __param(1, (0, common_1.Param)('companyId')),
    __param(2, (0, common_1.Param)('subOfficeId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, String, String]),
    __metadata("design:returntype", void 0)
], EmployeeController.prototype, "deleteSubOffice", null);
__decorate([
    (0, permissions_decorator_1.Permissions)({
        code: authorization_1.PermissionEnum.EMPLOYEE,
        isContract: true,
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_payload_dto_1.UserPayloadDto, employee_dto_1.FindEmployeeDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    (0, common_1.Get)('/id/:employeeId/:companyId?'),
    openapi.ApiResponse({ status: 200, type: require("../../entities/employee.entity").EmployeeEntity }),
    __param(0, (0, user_decorator_1.User)()),
