...
class CreateEmployeeDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { cpf: { required: true, type: () => String }, name: { required: true, type: () => String, maxLength: 100 }, status: { required: true, type: () => Object }, companyId: { required: true, type: () => String }, workplaceId: { required: true, type: () => String }, hierarchyId: { required: true, type: () => String } };
    }
}
__decorate([
...
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateEmployeeDto.prototype, "workplaceId", void 0);
__decorate([
