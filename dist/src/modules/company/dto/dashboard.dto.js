...
exports.FindCompanyDashDto = void 0;
const openapi = require("@nestjs/swagger");
const class_transformer_1 = require("class-transformer");
const class_validator_1 = require("class-validator");
const pagination_dto_1 = require("../../../shared/dto/pagination.dto");
const query_array_1 = require("../../../shared/transformers/query-array");
class FindCompanyDashDto extends pagination_dto_1.PaginationQueryDto {
...
], FindCompanyDashDto.prototype, "search", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], FindCompanyDashDto.prototype, "companyId", void 0);
__decorate([
    (0, class_transformer_1.Transform)(query_array_1.QueryArray, { toClassOnly: true }),
    (0, class_validator_1.IsString)({ each: true }),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", Array)
], FindCompanyDashDto.prototype, "companiesIds", void 0);
exports.FindCompanyDashDto = FindCompanyDashDto;
