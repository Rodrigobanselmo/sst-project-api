...
class WorkspaceDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: false, type: () => String }, abbreviation: { required: false, type: () => String }, name: { required: true, type: () => String, maxLength: 100 }, status: { required: true, type: () => Object }, address: { required: true, type: () => require("./address.dto").AddressDto } };
    }
}
__decorate([
