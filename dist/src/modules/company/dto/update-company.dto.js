...
class UpdateCompanyDto extends (0, swagger_1.PartialType)(create_company_dto_1.CreateCompanyDto) {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: false, type: () => String }, companyId: { required: true, type: () => String }, users: { required: true, type: () => [require("./update-user-company.dto").UserCompanyEditDto] }, employees: { required: true, type: () => [require("./employee.dto").UpdateEmployeeDto] } };
    }
}
__decorate([
