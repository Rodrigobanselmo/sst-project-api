...
class HierarchyOnHomogeneousEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { hierarchyId: { required: true, type: () => String }, homogeneousGroupId: { required: true, type: () => String }, workspaceId: { required: true, type: () => String }, hierarchy: { required: false, type: () => require("./hierarchy.entity").HierarchyEntity }, workspace: { required: false, type: () => require("./workspace.entity").WorkspaceEntity }, homogeneousGroup: { required: false, type: () => require("./homoGroup.entity").HomoGroupEntity } };
    }
}
