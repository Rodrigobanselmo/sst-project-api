...
class EnvironmentPhotoEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, companyEnvironmentId: { required: true, type: () => String }, name: { required: true, type: () => String }, photoUrl: { required: true, type: () => String, nullable: true }, created_at: { required: true, type: () => Date }, deleted_at: { required: true, type: () => Date }, updated_at: { required: true, type: () => Date } };
    }
}
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], EnvironmentPhotoEntity.prototype, "companyEnvironmentId", void 0);
__decorate([
