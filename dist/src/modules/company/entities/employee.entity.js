...
class EmployeeEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, cpf: { required: true, type: () => String }, status: { required: true, type: () => Object }, companyId: { required: true, type: () => String }, created_at: { required: true, type: () => Date }, updated_at: { required: true, type: () => Date }, workplaceId: { required: true, type: () => String }, hierarchyId: { required: true, type: () => String }, workspace: { required: false, type: () => require("./workspace.entity").WorkspaceEntity }, hierarchy: { required: false, type: () => require("./hierarchy.entity").HierarchyEntity }, directory: { required: false, type: () => String }, management: { required: false, type: () => String }, sector: { required: false, type: () => String }, sub_sector: { required: false, type: () => String }, office: { required: false, type: () => String }, sub_office: { required: false, type: () => String } };
    }
}
__decorate([
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The workplace id of the Employee' }),
    __metadata("design:type", String)
], EmployeeEntity.prototype, "workplaceId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The hierarchy id of the Employee' }),
    __metadata("design:type", String)
], EmployeeEntity.prototype, "hierarchyId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'The workspace related to the Employee' }),
    __metadata("design:type", workspace_entity_1.WorkspaceEntity)
], EmployeeEntity.prototype, "workspace", void 0);
__decorate([
