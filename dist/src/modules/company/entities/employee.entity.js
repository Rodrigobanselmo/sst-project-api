...
const employee_exam_history_entity_1 = require("./employee-exam-history.entity");
const employee_hierarchy_history_entity_1 = require("./employee-hierarchy-history.entity");
...
class EmployeeEntity {
    constructor(partial) {
        ...
        if (this.company) {
            this.company = new company_entity_1.CompanyEntity(this.company);
        }
        if (this.examsHistory) {
            this.examsHistory = this.examsHistory.map((examsHistory) => new employee_exam_history_entity_1.EmployeeExamsHistoryEntity(examsHistory));
        }
        if (this.hierarchyHistory) {
            this.hierarchyHistory = this.hierarchyHistory.map((hierarchyHistory) => new employee_hierarchy_history_entity_1.EmployeeHierarchyHistoryEntity(hierarchyHistory));
        }
    }
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => Number }, name: { required: true, type: () => String }, cpf: { required: true, type: () => String }, status: { required: true, type: () => Object }, companyId: { required: true, type: () => String }, created_at: { required: true, type: () => Date }, updated_at: { required: true, type: () => Date }, hierarchyId: { required: true, type: () => String }, workspaces: { required: false, type: () => [require("./workspace.entity").WorkspaceEntity] }, hierarchy: { required: false, type: () => Object }, subOffices: { required: false, type: () => [Object] }, directory: { required: false, type: () => String }, management: { required: false, type: () => String }, sector: { required: false, type: () => String }, sub_sector: { required: false, type: () => String }, office: { required: false, type: () => String }, sub_office: { required: false, type: () => String }, esocialCode: { required: true, type: () => String }, socialName: { required: true, type: () => String }, nickname: { required: true, type: () => String }, phone: { required: true, type: () => String }, email: { required: true, type: () => String }, isComorbidity: { required: true, type: () => Boolean }, sex: { required: true, type: () => Object }, cidId: { required: true, type: () => String }, shiftId: { required: true, type: () => Number }, birthday: { required: true, type: () => Date }, admissionDate: { required: true, type: () => Date }, lastExam: { required: true, type: () => Date }, expiredDateExam: { required: true, type: () => Date }, company: { required: false, type: () => require("./company.entity").CompanyEntity }, examsHistory: { required: false, type: () => [require("./employee-exam-history.entity").EmployeeExamsHistoryEntity] }, hierarchyHistory: { required: false, type: () => [require("./employee-hierarchy-history.entity").EmployeeHierarchyHistoryEntity] }, pppHistory: { required: false, type: () => [require("./employee-ppp-history.entity").EmployeePPPHistoryEntity] } };
    }
}
__decorate([
