...
let RiskGroupDataController = class RiskGroupDataController {
    constructor(upsertRiskGroupDataService, findAllByCompanyService, findByIdService, findDocumentsService) {
    ...
    findDocuments(riskGroupId, userPayloadDto) {
        const companyId = userPayloadDto.targetCompanyId;
...
__decorate([
    (0, common_1.Get)('documents/:riskGroupId/:companyId'),
    openapi.ApiResponse({ status: 200, type: [require("../../entities/riskDocument.entity").RiskDocumentEntity] }),
    __param(0, (0, common_1.Param)('riskGroupId')),
    __param(1, (0, user_decorator_1.User)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, user_payload_dto_1.UserPayloadDto]),
    __metadata("design:returntype", void 0)
], RiskGroupDataController.prototype, "findDocuments", null);
