...
let UpsertManyRiskDataService = class UpsertManyRiskDataService {
    ...
    async execute(upsertRiskDataDto) {
        const risksDataMany = (await Promise.all(upsertRiskDataDto.riskIds.map(async (riskId) => await this.riskDataRepository.upsertMany(Object.assign(Object.assign({}, upsertRiskDataDto), { riskId }))))) || [];
